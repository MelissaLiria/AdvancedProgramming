...
namespace Contracts.Samples
{
    public interface ISampleRepository
    {
        ...
        /// <summary>
        /// Obtienen una muestra del soporte de datos a partir de su identificador.
        /// </summary>
        /// <typeparam name="T">Tipo de muestra a obtener</typeparam>
        /// <param name="id">Identificador de la muestra</param>
        /// <returns>Muestra obtenida del soporte de datos; de no existir, <see langword="null"/>.</returns>
        ...
        /// <summary>
        /// Actualiza las propiedades de una muestra en el soporte de datos.
        /// </summary>
